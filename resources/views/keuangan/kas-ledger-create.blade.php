    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-5">
            ...
            <form action="/dashboard/keuangan/kas-ledger" method="GET" class="space-y-6">
                ...
                <div>
                    <label for="jumlah" class="block mb-2 text-gray-900 dark:text-white">Jumlah Uang</label>
                ...
                <div>
                    ...
                    <input type="text" id="sumber" name="sumber" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                </div>
                ...
                <div>
                    ...
                    <textarea id="description" rows="4" name="deskripsi" class="block p-2.5 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Tuliskan deskripsi untuk ledger ini..." required></textarea>
                </div>
