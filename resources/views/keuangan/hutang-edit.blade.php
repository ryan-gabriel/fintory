            ...
            <form action="/dashboard/keuangan/hutang/{{ $hutang->id }}" method="POST" class="space-y-6" id="form-edit">
                ...
                <div>
                    ...
                    <div class="relative max-w-sm">
                        ...
                        <input id="tanggal" name="tanggal" datepicker datepicker-autohide datepicker-buttons
                            type="text"
                            ...
                            placeholder="Select date" value="{{ old('tanggal',$hutang->tanggal_hutang) }}" required>
                    </div>
                </div>
