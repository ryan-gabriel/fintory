            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-800 dark:text-gray-100">
                    ...
                    <div>
                        ...
                        <p>{{ $mutation->product->kategori->nama ?? '-' }}</p>
                    </div>
                    <div>
                        <p class="text-sm font-semibold">Outlet Produk</p>
                        <p>{{ $mutation->product->outlet->name ?? '-' }}</p>
                    </div>
                    <div>
                        <p class="text-sm font-semibold">Outlet Mutasi</p>
                        <p>{{ $mutation->outlet->name ?? '-' }}</p>
                    </div>
                    <div>
                        <p class="text-sm font-semibold">Kuantitas Mutasi</p>
                    ...
                    <div>
                        <p class="text-sm font-semibold">Harga Jual Produk</p>
                        <p>Rp {{ number_format($mutation->product->harga_jual ?? 0, 0, ',', '.') }}</p>
                    </div>
                    <div>
                        <p class="text-sm font-semibold">Status Produk</p>
                        <p>{{ $mutation->product->is_active ? 'Aktif' : 'Nonaktif' }}</p>
                    </div>
                </div>
